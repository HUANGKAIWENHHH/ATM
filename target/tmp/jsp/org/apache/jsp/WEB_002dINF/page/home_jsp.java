...
return;
    ...
    try {
      ...
      out.write("                <div class=\"row  am-cf\" id=\"loadMyCards\">\n");
      out.write("                </div>\n");
      out.write("\n");
      out.write("               \n");
      out.write("\n");
      ...
      out.write("                                        </tr>\n");
      out.write("                                    </thead>\n");
      out.write("                                    <tbody id=\"listFlowTop10\">\n");
      out.write("\n");
      out.write("                                        \n");
      out.write("                                        <!-- more data -->\n");
      out.write("                                    </tbody>\n");
      ...
      out.write("            listFlowTop10()\n");
      out.write("            loadMyCards()\n");
      out.write("        });\n");
      out.write("        \n");
      out.write("        function loadMyCards() {\n");
      out.write("            $.ajax({\n");
      out.write("                url:\"/card/listMyCard.do\",\n");
      out.write("                type:\"POST\",\n");
      ...
      out.write("                            '                    </div>'\n");
      out.write("                    }\n");
      out.write("                    $('#loadMyCards').html(msg)\n");
      out.write("                },\n");
      ...
      out.write("        }\n");
      out.write("        \n");
      out.write("        function listFlowTop10() {\n");
      out.write("            $.ajax({\n");
      out.write("                url: \"/card/listFlowTop10.do\",\n");
      out.write("                type: \"POST\",\n");
      out.write("                dataType: \"json\",\n");
      out.write("                data: {},\n");
      out.write("                success: function (data) {\n");
      ...
      out.write("                            '                                            <td>' + data.data[i].cardNumber + '</td>\\n' +\n");
      out.write("                            '                                            <td>' + data.data[i].amount + '</td>\\n' +\n");
      out.write("                            '                                            <td>' + data.data[i].flowDesc + '</td>\\n' +\n");
      out.write("                            '                                            <td>' + data.data[i].flowCreateTime + '</td>\\n' +\n");
      out.write("                            '                                        </tr>'\n");
      out.write("                    }\n");
      out.write("                    $('#listFlowTop10').html(msg)\n");
      out.write("                },\n");
      out.write("                error: function (e) {\n");
      out.write("                    console.log(e)\n");
      out.write("                    alert(\"error\")\n");
